...
WEB_PUSH_VAPID_PRIVATE_KEY_PATH = os.environ.get("WEB_PUSH_VAPID_PRIVATE_KEY_PATH", "")
WEB_PUSH_VAPID_PUBLIC_KEY = os.environ.get("WEB_PUSH_VAPID_PUBLIC_KEY", "")
WEB_PUSH_VAPID_ADMIN_EMAIL = os.environ.get(
    "WEB_PUSH_VAPID_ADMIN_EMAIL",
    "mailto:tymofey.meshkov@gmail.com",
)